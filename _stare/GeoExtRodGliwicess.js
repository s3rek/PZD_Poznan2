...
//no-comment
var mapPanel, warstwyPanel, map, wfsDzialki, wfsOgrody, measureControls, desc, logBttn, _usr, _upr, popup, aktywnyOgrod;
...
*/
    ...
    {
    		title:'Uprasza siê o zalogowanie Waæpanie',
        layout: 'fit',
        width: 250,
        height: 135,
        resizable: false,
...
/*                ,
        sm: new GeoExt.grid.FeatureSelectionModel({
        		singleSelect: true,
        		selectControl: selectAnalizy,
        		listeners: {
		        		rowselect: function(smObj, rowIndex, record){
		        				//var feature = record.get("feature");
				        		//var bounds = feature.geometry.getBounds();
				        		//podobnie mozna odpolic colmunmodel
		        				//var fid = feature.fid;
...
*/	
    ...
    var treeConfig = new OpenLayers.Format.JSON().write([{
        ...
        text: "WarstwyPodkladowe",
        expanded: true
    }, {
        nodeType: "gx_overlaylayercontainer",
        text: "WarstwyWektorowe",
        expanded: true,
    ...
    warstwyPanel = new Ext.tree.TreePanel({
        ...
        ,
        bbar: [{
            text: "Pokaz/Edytuj 'config' drzewa",
            handler: function() {
                treeConfigWin.show();
