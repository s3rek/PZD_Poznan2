       ...
       buttons:[{
            ...
            handler:function(){
            		...
            		if(wgrajWMSPanel.getForm().isValid()){
						abc = wgrajWMSPanel.getForm().findField('um1_WMS').getValue();
...
for(var i=0;i<2;i++)
	...
	var treeConfig2 = new OpenLayers.Format.JSON().write([
	{	
...
setCookie('warstwa','UM Gliwice*UM Gliwice1*',(525600*60*1000));
setCookie('WMS','http://msip-mapa.um.gliwice.pl/portal/isdp/scripts/isdp.dll/wms/1.1.1*http://msip-mapa.um.gliwice.pl/portal/isdp/scripts/isdp.dll/wms/1.1.1*',(525600*60*1000));
var child = [{
	text:'1',
		children: Ext.decode(treeConfig1)
},{
		text:'2',
		children: Ext.decode(treeConfig2)
		}]
