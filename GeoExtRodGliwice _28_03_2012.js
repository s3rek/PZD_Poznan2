...
//no-comment
var mapPanel, warstwyPanel, warstwyDodatkowe, map, wfsDzialki, wfsOgrody, measureControls, desc, logBttn, _usr, _upr, popup, aktywnyOgrod, nenene;
...
Ext.onReady(function() {
	...
	if( getCookie('warstwa')){
		...
		var layerzcookie = getCookie('layers');
		//alert(layerzcookie);
...
*/
    ...
    map.events.register('moveend', this, function() {
		...
		if(wararray!=null){
			...
			for(var i=0;i<wararray.length;i++){
				//if(i==0)
				for(var t=1;t<layerarray[i].length;t++){
					temp_layer = temp_layer + '"' + layerarray[i][t];
					if(t<25){
...
*/
				...
				eval('var um_wms'+i+' = new OpenLayers.Layer.WMS( "'+wararray[i]+'", "'+ wmsarray[i]+'", {	'+ temp_layer +',	projection: new OpenLayers.Projection("EPSG:900913"),"transparent": true}, {visibility: false,	isBaseLayer: false,displayInLayerSwitcher: false }	);');
				//alert((string)um_wmso0);
				
					um_wms_tab[i] = 'um_wms'+i;
				//if(i==1)
		    ...
		    items: [
		    		{
				        ...
				        handler: function(e){
				        		alert('wczytywanie WMS w budowie')
				        }
						},
						{
				        scale: 'large',
